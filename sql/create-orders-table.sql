...
CREATE TABLE IF NOT EXISTS orders (
  ...
  payment_status TINYINT UNSIGNED NOT NULL DEFAULT 1 COMMENT '0未支付 1已支付 2退款中 3已退款 4退款失败',
  ...
  refund_status VARCHAR(32) NULL COMMENT '微信退款状态 SUCCESS/PROCESSING 等',
  ...
  UNIQUE KEY uk_orders_refund_no (refund_no),
